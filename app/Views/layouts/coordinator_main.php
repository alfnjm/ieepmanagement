...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <h4>Coordinator</h4>
            <small>IEEP Management Panel</small>
        </div>
        
        <ul class="sidebar-nav">
            <li>
                <a href="<?= base_url('coordinator/dashboard') ?>" class="nav-link <?= (uri_string() == 'coordinator/dashboard') ? 'active' : '' ?>">
                    <i class="bi bi-grid-fill"></i> Dashboard
                </a>
            </li>
            <li>
                <a href="<?= base_url('coordinator/proposals') ?>" class="nav-link <?= (uri_string() == 'coordinator/proposals') ? 'active' : '' ?>">
                    <i class="bi bi-file-earmark-text-fill"></i> Program Proposals
                </a>
            </li>
            <li>
                <a href="<?= base_url('coordinator/registration') ?>" class="nav-link <?= (uri_string() == 'coordinator/registration') ? 'active' : '' ?>">
                    <i class="bi bi-toggles"></i> Registration Control
                </a>
            </li>
            <li>
                <a href="<?= base_url('coordinator/upcoming') ?>" class="nav-link <?= (uri_string() == 'coordinator/upcoming') ? 'active' : '' ?>">
                    <i class="bi bi-calendar-event-fill"></i> Upcoming Events
                </a>
            </li>
            <li>
                <a href="<?= base_url('coordinator/approvals') ?>" class="nav-link <?= (uri_string() == 'coordinator/approvals') ? 'active' : '' ?>">
